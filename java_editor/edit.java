...
public class AdvancedTextEditor extends JFrame {
    ...
    private void setupMenuBar() {
        ...
        editMenu.add(createMenuItem("Comment/Uncomment", "ctrl L", e -> commentUncommentLines()));
        editMenu.addSeparator();
    ...
    private void setupKeyBindings() {
        // Key bindings are handled through menu mnemonics and accelerators
        // Additional custom key bindings can be added here
    }
        ...
        SwingWorker<String, Void> worker = new SwingWorker<String, Void>() {
            ...
            protected void done() {
                try {
                    ...
                    showErrorDialog("Error opening file: " + e.getCause().getMessage());
                }
            }
        };
        worker.execute();
        ...
        SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            ...
            protected void done() {
                try {
                    ...
                    showErrorDialog("Error saving file: " + e.getCause().getMessage());
                }
            }
        };
        worker.execute();
    ...
    private void toggleSplitView(boolean horizontal) {
        ...
        if (splitView && tabbedPane.getTabCount() > 1) {
            ...
            if (currentTab != null) {
                ...
                splitPane.setLeftComponent(new JScrollPane(currentTab.getTextArea()));
                splitPane.setRightComponent(new JScrollPane(splitTab.getTextArea()));
    ...
    private void updateStatus() {
        ...
        if (currentTab != null) {
            ...
            int caretPos = currentTab.getTextArea().getCaretPosition();
...
class EditorTab extends JPanel {
    ...
    public void duplicateLine() {
        try {
            ...
            textArea.insert(lineText, lineEnd);
...
class FindReplaceDialog extends JDialog {
    ...
    private void findPrevious() {
        ...
        if (currentTab != null) {
            JTextArea textArea = currentTab.getTextArea();
            String content = textArea.getText();
            int startPos = Math.max(0, textArea.getSelectionStart() - 1);
...
class GoToLineDialog extends JDialog {
    ...
    private void goToLine() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error navigating to line",
